...
The demonstration video has rendered to `output/Pantry-Relay-Demo.mp4`: 1920 by 1080 pixels, H.264 video and AAC audio, duration 170.633333 seconds. Evidence is `artifacts/verification/video-metadata.json`. The public walkthrough at https://pantryrelay.web.app/demo is deployed and verified in Chromium and WebKit. Both played the unmuted 1920 by 1080 video, advanced playback, sought successfully and loaded the pitch PDF with HTTP 200. The page had no horizontal overflow at 390 pixels. Evidence: `artifacts/verification/demo-media-verification.json`. One WebKit range request was canceled during seeking; seeking and playback succeeded with an audio track and no media, page, console or CSP errors. YouTube publication is confirmed at https://www.youtube.com/watch?v=dSc6ToJ2z6Y, and Devpost confirmed submission at https://devpost.com/software/pantry-relay.

## Submission status

Devpost confirmed **“Project submitted!”** on September 22, 2026 at https://devpost.com/software/pantry-relay. The overview, branded thumbnail, full story, nine technology tags, three URLs, three captioned gallery images, YouTube video link and judge ZIP are saved. The final optional attachment was explicitly shown as `Current File: Pantry-Relay-Submission-Kit-Final.zip`. There is no separate testing-instructions field; those instructions are in the ZIP and linked from the story.

YouTube confirmed **“Video published”**, public visibility, and **“Checks complete. No issues found.”** The public watch page displayed the correct title, description, custom thumbnail, chapters and AI-content disclosure. Its rendered video element progressed from 15.466827 to 52.123683 seconds, with duration 170.681 seconds, readyState 4 and no media error. Playback first used a 640 by 360 rendition. Selecting the public 1080p HD option decoded 1920 by 1080 video, advanced to 96.534395 seconds, and retained readyState 4 with no media error. The manually timed SRT was imported and published; public settings show Subtitles/CC English. Burned-in captions also remain visible in the video itself. Browser accessibility snapshots initially showed stale time labels, so playback verification used the actual rendered media element through the supported browser connection. See `artifacts/verification/publication.json`.

The participant confirmed publication and submission and completed Google account authentication. Devpost acceptance does not independently verify human-team, location or in-person presentation eligibility.
